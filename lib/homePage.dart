...
import 'widgets/CounterRow.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  loadCounter(
                      ...
                      "#site-dashboard > div > div > div > div > ul > li.bg-blue > strong",
                      30.0,
                      "Active",
                      Colors.orange),
                  loadCounter(
                      "https://www.mohfw.gov.in/index.html",
                      "#site-dashboard > div > div > div > div > ul > li.bg-red > strong",
                      30.0,
                      "Dead",
                      Colors.red),
                  loadCounter(
                      "https://www.mohfw.gov.in/index.html",
                      "#site-dashboard > div > div > div > div > ul > li.bg-green > strong",
                      30.0,
                      "Recovered",
                      Colors.green),
                ],
            ...
            Container(
              ...
              child: loadCounter(
                  "https://www.mohfw.gov.in/index.html",
                  "#state-data > div > div > div > div > table > tbody > tr > td[align] > strong",
                  30.0,
                  "Total Cases",
                  Colors.blue),
            ),
            ...
            Container(
              ...
              child: loadCounter(
                  ...
                  "#newsdate$year-$month-$day > div > div > ul > li > strong",
                  20.0,
                  "Observed on $day-$month-$year alone",
                  Colors.purple),
            ),
          ],
        ),
